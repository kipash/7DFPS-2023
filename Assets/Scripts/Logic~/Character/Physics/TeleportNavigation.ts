...
import { Mathf, getTempVector, serializable, setWorldPosition } from "@needle-tools/engine";
...
export class TeleportNavigation extends PlayerModule {
    ...
    getSafeTargetFromPointer(camera: THREE.Camera, screenPositionRC: Vector2): { pos: Vector3, normal: Vector3 } | null {
        ...
        // get target
        const result = this.context.physics.engine?.raycastAndGetNormal(pointerPos, direction, this.maxRaycastDistance, true);
