import { Vector3, Vector2, Quaternion, MathUtils } from "three";
...
export class POVCamera extends PlayerCamera {
    @serializable()
    ...
    moduleOnBeforeRender(): void {
        ...
        const x = inputState.lookDeltaX ?? 0;
        const y = inputState.lookDeltaY ?? 0;
